    ...
    Item {
        ...
        CheckBox {
            ...
            indicator: Rectangle {
                ...
                implicitHeight: root.font.pointSize * 1.2
                implicitWidth: root.font.pointSize * 1.2
                color: Qt.rgba(1, 1, 1, 0.05)
                border.color: Qt.rgba(1, 1, 1, 0.2)
                border.width: parent.activeFocus ? 2 : 1
                radius: 4
            ...
            contentItem: Text {
                ...
                anchors.leftMargin: indicator.width / 1.5
                font.pointSize: root.font.pointSize * 0.75
                color: Qt.rgba(root.palette.text.r, root.palette.text.g, root.palette.text.b, 0.8)
    ...
    Item {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                gradient: Gradient {
                    GradientStop { position: 0.0; color: loginButton.enabled ? "#667eea" : Qt.rgba(0.4, 0.49, 0.92, 0.3) }
                    GradientStop { position: 1.0; color: loginButton.enabled ? "#764ba2" : Qt.rgba(0.46, 0.29, 0.64, 0.3) }
                }
                ...
                layer.effect: DropShadow {
                    ...
                    radius: 8
                    samples: 17
                    color: Qt.rgba(0.4, 0.31, 0.64, 0.4)
                }
            }
            ...
            transitions: [
                Transition {
                    PropertyAnimation {
                        properties: "opacity, color, scale"
                        duration: 300
